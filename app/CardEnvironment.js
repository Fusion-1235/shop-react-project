...
export default function CardEnvironment() {
  return (
    <div className="grid md:gap-12 flex-row-reverse md:flex items-center bg-white rounded-lg p-6 text-right direction-rtl mx-auto mt-10" style={{ boxShadow: '0 20px 60px rgba(0, 0, 0, 0.2)' }}>
